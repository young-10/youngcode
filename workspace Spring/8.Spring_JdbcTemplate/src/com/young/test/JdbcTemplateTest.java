...
import com.young.dao.EmployeeDao;
...
public class JdbcTemplateTest {
	...
	public void test09() {
		...
		int update = namejdbcJdbcTemplate.update(sql, new BeanPropertySqlParameterSource(employee));
	...
	public void test10() {
		...
		Employee employee = new Employee(45,"world",45.3);
